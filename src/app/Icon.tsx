...
export type IconName =
  ...
  | 'camera' | 'finger' | 'copy' | 'bell' | 'close' | 'sparkle' | 'scan' | 'flash' | 'cart'
...
export function Icon({ name, size = 22, strokeWidth = 1.9, style, className }: { name: IconName; size?: number; strokeWidth?: number; style?: CSSProperties; className?: string }) {
  ...
  switch (name) {
    ...
    case 'cart':
      return <svg {...p}><path d="M3 4h2l2.4 11.2a1 1 0 0 0 1 .8h9.4a1 1 0 0 0 1-.8L20.5 8H6" /><circle cx="9.5" cy="19.5" r="1.2" /><circle cx="17" cy="19.5" r="1.2" /></svg>
    case 'flash':
