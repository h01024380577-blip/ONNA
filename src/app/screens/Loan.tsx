...
import { LOAN, benchmark, monthlyPayment, totalRepay } from '../../mock/loan'
...
export function D3() {
  const { state, dispatch, p, t, krw } = useApp()
  const offer = useCredit(state.loanDraft.months)
